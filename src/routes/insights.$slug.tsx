...
const SLUGS = translations.en.articles.map((a) => a.slug);
  {
    ...
    sections: [
      ...
      { type: "p", text: "The improvements disappear, not because the ideas were poor, but because they were never integrated into daily operations." },
      ...
      { type: "quote", text: "The strongest improvement culture is built through daily management, not occasional enthusiasm." },
      ...
      { type: "p", text: "These observations reveal whether improvement is part of the operating system or simply another project." },
      ...
      { type: "p", text: "Because standard work was never updated consistently, many improvements gradually disappeared." },
      ...
      { type: "p", text: "If the answer is no, improvement may still depend on projects rather than your management system." },
    ],
  },
  {
